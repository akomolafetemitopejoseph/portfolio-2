        ...
        <div>
          <div className="flex-1 lg:flex">
            <div>
              ...
              <p className="text-gray-400 text-[14px] lg:text-xl ">
              ...
              <div className=" flex justify-center lg:flex lg:justify-evenly mt-5 lg:mt-10 lg:mb-10">
                <div className="grid grid-cols-1 justify-center items-center gap-2 lg:flex">
                  <button className="uppercase mb-3 flex justify-center items-center gap-2 p-3  hover:bg-green-800 transform duration-500 active:bg-green-900 font-semibold text-xl lg:text-2xl border-2 border-green-900 px-2 lg:px-5 lg:py-3 rounded cursor-pointer w-fit ">
                    download cv
                    <CiSaveDown1 />
                  </button>
                  <button className="uppercase mb-3 flex justify-center items-center gap-2 p-3 hover:bg-green-800 transform duration-500 active:bg-green-900 font-semibold text-xl lg:text-2xl border-2 border-green-900 px-2 lg:px-5 lg:py-3 rounded cursor-pointer   w-fit">
              ...
              <div className="flex gap-5 text-center justify-center items-center  mt-2">
                <FaLinkedinIn className="text-xl lg:text-4xl cursor-pointer hover:text-green-300 transform duration-500" />
                <FaGithub className="text-xl lg:text-4xl cursor-pointer  hover:text-green-300 transform duration-500" />
                <BsTwitterX className="text-xl lg:text-4xl cursor-pointer hover:text-green-300 transform duration-500" />
              </div>
            </div>
          </div>
        </div>
