...
const HeroSection = () => {
  return (
    <main
      ...
      id="home"
      className=" flex-1 lg:justify-center text-center lg:flex gap-20 px-5 py-5  lg:px-10 lg:pt-10 text-white h-screen"
    >
      ...
      <div>
        <div>
          <div className="flex-1 lg:flex mt-10 lg:mt-20">
            <div>
              <h1 className="text-2xl mt-3 lg:text-2xl font-extrabold mb-3 lg:mb-5 underline underline-offset-5 decoration-5 under ">
                Frontend Developer
              </h1>
